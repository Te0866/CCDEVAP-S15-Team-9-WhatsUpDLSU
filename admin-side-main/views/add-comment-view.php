...
<link rel="stylesheet" href="../assets/styles/admin/add-comment.css">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
    </head>

    <body class="s-admin-add-comment s-admin-darkmode">
        <nav class="navbar">
            <div class="nav-left">
...
<script src="../assets/scripts/admin/add-comment.js"></script>
