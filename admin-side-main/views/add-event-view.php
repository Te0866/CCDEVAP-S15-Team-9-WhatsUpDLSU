...
<link rel="stylesheet" href="../assets/styles/admin/add-event.css">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
    </head>

    <body class="s-admin-add-event s-admin-darkmode">
        <nav class="navbar">
            <div class="nav-left">
        ...
        <main class="create-page">
            ...
            <form method="POST" action="save-event.php" enctype="multipart/form-data">
...
<script src="../assets/scripts/admin/add-event.js"></script>
