...
<link rel="stylesheet" href="../assets/styles/admin/add-student.css">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
    </head>

    <body class="s-admin-add-student s-admin-darkmode">
        <nav class="navbar">
            <div class="nav-left">
        ...
        <main class="create-page">
            ...
            <form method="POST" action="save-student.php" id="studentForm">
...
<script src="../assets/scripts/admin/add-student.js"></script>
