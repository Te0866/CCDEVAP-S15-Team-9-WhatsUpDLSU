(function () {
    try {
        ...
        // Resolve banner image src so bare filenames and full relative paths both work
        function resolveEventImageSrc(src) {
            if (!src) return src;
        ...
        function renderImageCarousel(images) {
            ...
            images.forEach((src, i) => {
                ...
                slide.innerHTML = `<img src="${resolveEventImageSrc(src)}" alt="Event image ${i + 1}">`;
                track.appendChild(slide);
