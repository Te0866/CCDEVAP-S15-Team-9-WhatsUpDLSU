...
<link rel="stylesheet" href="../assets/styles/org/edit-organization.css">
</head>

<body class="s-org-edit-organization s-org-darkmode s-org-modal">
    ...
    <main class="edit-page">
        ...
        <div class="form-card">
            ...
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    <input type="password" id="retypePassword" name="retype_password" placeholder="Re-enter password">
...
<script src="../assets/scripts/org/edit-organization.js"></script>
</body>
</html>
