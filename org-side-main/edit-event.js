...
// Hook up the remove button for the image already saved in the DB (rendered by PHP)
...
// Show feedback whenever a new file is picked, replacing whatever chip was there before
fileInput.addEventListener("change", () => {
    ...
    if (fileInput.files.length > 0) {
        if (removeImageFlag) {
            removeImageFlag.value = "0"; // a newly picked file overrides any pending removal
        }
